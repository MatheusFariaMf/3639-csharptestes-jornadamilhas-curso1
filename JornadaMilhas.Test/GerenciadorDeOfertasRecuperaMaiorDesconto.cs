...
namespace JornadaMilhas.Test
{
    public class GerenciadorDeOfertasRecuperaMaiorDesconto
    {
        ...
        public void RetornaOfertaNulaQuandoListaVazia()
        {
            ...
            Func<OfertaViagem, bool> condicao = o => o.Rota.Destino.Equals("São Paulo");
            // Act
            var oferta = gerenciador.RecuperaMaiorDesconto(condicao);
            // Assert
            Assert.Null(oferta);
        ...
        public void RetornaOfertaEspecificaQuandoDestinoSaoPauloEDescontoQuarenta()
        {
            ...
            var rotaEscolhida = new Rota("Curitiba", "São Paulo");
            var rota = new Rota("Curitiba", "Não é São Paulo");
            ...
            var ofertaEscolhida = new OfertaViagem(rotaEscolhida, fakerPeriodo.Generate(), 80)
            {
                Desconto = 40,
                Ativa = true
            };

            var ofertaInativa = new OfertaViagem(rotaEscolhida, fakerPeriodo.Generate(), 70)
            {
                Desconto = 40,
                Ativa = false
            };
            ...
            var gerenciador = new GerenciadorDeOfertas(lista);
            Func<OfertaViagem, bool> condicao = o => o.Rota.Destino.Equals("São Paulo") && o.Ativa;
